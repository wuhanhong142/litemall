package com.bestsoft.litemall.core.system;

import com.bestsoft.litemall.core.util.SystemInfoPrinter;
import com.bestsoft.litemall.db.service.LitemallSystemConfigService;
...
class SystemInistService {
    ...
    private Map<String, String> getSystemInfo() {
        ...
        infos.put("调试级别", environment.getProperty("logging.level.com.bestsoft.litemall.wx"));
